...
# build directory.
TCL_BUILD_LIB_SPEC='-L/cygdrive/c/avrdev/insight/build/tcl/win -ltcl84'
...
TCL_INCLUDE_SPEC='-Ic:/WinAVR/include'
...
# compiled.
TCL_SRC_DIR='/cygdrive/c/avrdev/insight/insight-6.4/tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/cygdrive/c/avrdev/insight/build/tcl/win -ltclstub84'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lc:/WinAVR/lib -ltclstub84'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/cygdrive/c/avrdev/insight/build/tcl/win/libtclstub84.a'
