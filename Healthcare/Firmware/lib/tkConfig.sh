...
TK_XINCLUDES='-I"/cygdrive/c/avrdev/insight/insight-6.4/tk/xlib"'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/cygdrive/c/avrdev/insight/build/tk/win -ltk84'
...
# compiled.
TK_SRC_DIR='/cygdrive/c/avrdev/insight/insight-6.4/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/cygdrive/c/avrdev/insight/build/tk/win -ltkstub84'
